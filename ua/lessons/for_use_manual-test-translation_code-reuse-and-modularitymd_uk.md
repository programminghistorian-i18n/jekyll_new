---
title: Повторне використання коду та модульність у Python
layout: lesson
date: 2012-07-17
authors:
- William J. Turkel
...
topics: [python]
abstract: "Комп’ютерні програми можуть стати довгими, громіздкими та заплутаними без спеціальних механізмів керування їх складністю. Цей урок покаже вам, як повторно використовувати частини вашого коду, створюючи функції та розбиваючи ваші програми на модулі, щоб зберегти все стисло та легше для налагодження."
...
Комп’ютерні програми можуть стати довгими, громіздкими та заплутаними
без спеціальних механізмів керування їх складністю. Цей урок покаже вам
як повторно використовувати частини свого коду, сторюючи *функції* та організовувати ваші
програми у *модулі*, щоб код був стислим та легше
відлагоджуваним. Можливість видалення одного непрацюючого модуля може заощадити час
і зусилля.
