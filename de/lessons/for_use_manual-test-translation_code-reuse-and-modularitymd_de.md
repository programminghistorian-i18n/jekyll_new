---
title: Code Wiederverwendung und Modularisierung in Python
layout: lesson
date: 2012-07-17
authors:
- William J. Turkel
...
topics: [python]
abstract: "Ohne spezielle Mechanismen zur Verwaltung der Komplexität können Computerprogramme lang, unhandlich und verwirrend werden. Diese Lektion zeigt, wie Teile des Codes wiederverwendet werden können, indem Sie *Funktionen* schreiben und die Programme in *Module* aufteilen, um alles übersichtlich und einfacher zu debuggen."
...
Ohne spezielle Mechanismen zur Verwaltung der Komplexität
können Computerprogramme lang, unhandlich und verwirrend werden. Diese Lektion zeigt,
wie Teile des Codes wiederverwendet werden können, indem Sie *Funktionen* schreiben und die
Programme in *Module* aufteilen, um alles übersichtlich und einfacher
zu debuggen. Die Möglichkeit, ein einzelnes fehlerhaftes Modul zu entfernen, kann Zeit
und Mühe sparen.
